...
use crate::crypt::{BlockCrypt, CryptEngine};
...
impl CryptoBuf {
    ...
    #[inline]
    pub fn seal_aead(&mut self, aead: &dyn crate::crypt::AeadCrypt, data: &[u8]) -> Bytes {
...
mod tests {
    ...
    fn encrypt_packet_uses_cfb_header_for_all_cfb_ciphers() {
        ...
        assert_eq!(s.len(), CRYPT_HDR + plain.len(), "salsa must use CFB header");
